...
void menu(char key)
{
    ...
    {
        clcd_print("MENU ENTER..    ", (0x80 + (0)));
        menu_f = item_ind + line - 1;
        clcd_print("                ", (0xC0 + (0)));
        clcd_print(menu_item[menu_f], (0xC0 + (0)));
        main_f = 3;
    ...
    clcd_print(menu_item[item_ind], (0x80 + (1)));
    clcd_print(menu_item[item_ind + 1], (0xC0 + (1)));
}
