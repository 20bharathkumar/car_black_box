...
void change_pass(char key)
{
    ...
    if(screen == 0)
    {
        clcd_print("ENTER OLD PSWD  ", (0x80 + (0)));


        if(flag)
        {
            clcd_print("_", (0xC0 + (ind)));
        }
        else
        {
            clcd_print(" ", (0xC0 + (ind)));
        ...
        if(ind == 4)
        {
            ...
            if(check_password())
            {
                ...
                clcd_print("ENTER NEW PSWD   ", (0x80 + (0)));
                clcd_print("                 ", (0xC0 + (0)));
                screen = 1;
                ind = 0;
            }
    ...
    else if(screen == 1)
    {
        ...
        if(ind == 4)
        {
            clcd_print("REENTER NEW PSWD ", (0x80 + (0)));
            clcd_print("                 ", (0xC0 + (0)));
            screen = 2;
            ind = 0;
        }
